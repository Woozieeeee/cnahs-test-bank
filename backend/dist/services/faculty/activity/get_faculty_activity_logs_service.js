...
exports.getFacultyActivityLogsService = void 0;
const prisma_1 = __importDefault(require("../../../lib/prisma"));
const HIDDEN_ACTIONS = ["APPROVE_STUDENT", "REJECT_STUDENT", "CREATE_FACULTY"];
const getFacultyActivityLogsService = async ({ facultyId, page = 1, limit = 10, search = "", category, severity, }) => {
...
exports.getFacultyActivityLogsService = getFacultyActivityLogsService;
