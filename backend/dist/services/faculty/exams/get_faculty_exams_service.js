...
exports.getFacultyExamsService = void 0;
const prisma_1 = __importDefault(require("../../../lib/prisma"));
const getFacultyExamsService = async (facultyId, filter) => {
    ...
    if (filter?.sectionId)
        filtered = filtered.filter((e) => e.sectionId === filter.sectionId);
...
exports.getFacultyExamsService = getFacultyExamsService;
