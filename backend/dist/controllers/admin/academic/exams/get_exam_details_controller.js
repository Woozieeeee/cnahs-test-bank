...
exports.getExamDetailsController = void 0;
...
const getExamDetailsController = async (req, res) => {
    try {
        ...
        const difficultyBreakdown = {
            EASY: exam.examQuestions.filter((eq) => eq.question.difficulty === "EASY").length,
            MEDIUM: exam.examQuestions.filter((eq) => eq.question.difficulty === "MEDIUM").length,
            HARD: exam.examQuestions.filter((eq) => eq.question.difficulty === "HARD").length,
            EXPERT: exam.examQuestions.filter((eq) => eq.question.difficulty === "EXPERT").length,
        };
...
exports.getExamDetailsController = getExamDetailsController;
