...
exports.getSectionStudentsController = void 0;
    ...
    try {
        ...
        const studentsWithStatus = students.map((student) => {
            ...
            if (totalAttempts === 0) {
                ...
                // Calculate pass rate
                const passedExams = student.examAttempts.filter((attempt) => attempt.score >= attempt.exam.passingScore);
            ...
            return {
                ...
                passedExams: student.examAttempts.filter((a) => a.score >= a.exam.passingScore).length,
        ...
        return res.status(200).json({
            ...
            data: {
                ...
                stats: {
                    passing: studentsWithStatus.filter((s) => s.studentStatus === "PASSING").length,
                    inactive: studentsWithStatus.filter((s) => s.studentStatus === "INACTIVE").length,
                    struggling: studentsWithStatus.filter((s) => s.studentStatus === "STRUGGLING").length,
                },
            },
        });
    }
...
exports.getSectionStudentsController = getSectionStudentsController;
