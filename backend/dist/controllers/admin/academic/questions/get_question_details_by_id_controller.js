...
exports.getQuestionDetailsByIdController = void 0;
const prisma_1 = __importDefault(require("../../../../lib/prisma"));
/**
 * GET /api/admin/academic/questions/:questionId
 * Get detailed information about a specific question
 */
const getQuestionDetailsByIdController = async (req, res) => {
    try {
        ...
        const correctAttempts = question.studentAnswers.filter((a) => a.isCorrect).length;
...
exports.getQuestionDetailsByIdController = getQuestionDetailsByIdController;
