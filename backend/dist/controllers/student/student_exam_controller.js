...
exports.getExamController = void 0;
const student_exam_service_1 = require("../../services/student/student_exam_service");
/**
...
const getExamController = async (req, res) => {
    try {
        ...
        const examData = await (0, student_exam_service_1.getExamData)(examId);
        if (!examData) {
            console.error(`[ExamController] Exam not found for exam ${examId}`);
