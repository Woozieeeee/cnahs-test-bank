...
interface UpdateSecurityPoliciesInput {
...
export const updateSecurityPoliciesService = async (
  data: UpdateSecurityPoliciesInput
) => {
  try {
    ...
    console.error(
      "[SecurityPoliciesService] Error updating policies:",
      error
    );
    throw error;
  }
