...
interface Props {
  questions: StrongQuestion[];
}

function StrongQuestionsTable({ questions }: Props) {
    ...
    <div className="border-border bg-card mt-6 overflow-hidden rounded-2xl border">
      <div className="border-border border-b p-5">
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          Questions with consistently high student success
          rates.
        </p>
      </div>
...
export default memo(StrongQuestionsTable);
