...
function FacultyAccountInfo({ user }: Props) {
  if (!user) return null;
  ...
  return (
    <section>
      ...
      <p className="mt-4 text-xs text-muted-foreground">
        📌 <strong>Note:</strong> To update your account information, please contact the system administrator.
      </p>
    </section>
  );
}

export default memo(FacultyAccountInfo);
